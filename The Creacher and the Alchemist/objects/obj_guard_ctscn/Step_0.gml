...
if(dw>=270&&dw<=280){
	if(obj_girl_ctscn2.sprite_index!=spr_girl_walkdown){
	obj_girl_ctscn2.sprite_index = spr_girl_walkdown;
...
if(dw==160){
	obj_creacher_ctscn2.y_spd = -2;
	obj_creacher_ctscn2.image_speed = 1;
	obj_girl_ctscn2.donewalking = 161;
	if(obj_creacher_ctscn2.y<=obj_girl_ctscn2.y+128){
		obj_creacher_ctscn2.y_spd = 0;
		obj_creacher_ctscn2.image_speed = 0;
		obj_girl_ctscn2.donewalking = 159;
	}
}
...
if(dw==150){
	obj_creacher_ctscn2.x_spd = -8;
	obj_creacher_ctscn2.image_speed = 1;
	obj_girl_ctscn2.donewalking = 151;
	if(obj_creacher_ctscn2.x<=obj_girl_ctscn2.x-128){
		obj_creacher_ctscn2.y_spd = 0;
		obj_creacher_ctscn2.x_spd = 0;
		obj_girl_ctscn2.donewalking = 150;
	}
}
...
if(dw==147){
	...
	if(obj_creacher_ctscn2.y>=obj_girl_ctscn2.y){
		...
		obj_creacher_ctscn2.x_spd = 0;
		obj_creacher_ctscn2.image_speed = 0;
		obj_creacher_ctscn2.image_index = 2;
		obj_girl_ctscn2.donewalking = 147;
...
if(dw==87){
	obj_girl_ctscn2.x_spd = 4;
	obj_girl_ctscn2.y_spd = -4;
	obj_girl_ctscn2.image_speed = 3;
	obj_creacher_ctscn2.x_spd = 4;
	obj_creacher_ctscn2.y_spd = -4;
	obj_creacher_ctscn2.image_speed = 1;
}

if(dw<87&&obj_girl_ctscn2.y<=800&&obj_girl_ctscn2.y_spd!=0){
	obj_girl_ctscn2.y_spd = 0;
	obj_creacher_ctscn2.y_spd = 0;
}

if(dw<87&&obj_girl_ctscn2.x>=1760){
	dw = 0;
}
...
if(dw==0){
	...
	obj_girl_ctscn2.donewalking = -15;
	dw = -15;
}

if(dw==-15&&obj_shift.image_index>12&&obj_shift.image_speed = -1){
	obj_shift.image_index = 13;
}
